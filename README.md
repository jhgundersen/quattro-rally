...
Choose **Create a room**, copy its invitation link, and send it to friends. Up to four people can join without accounts. The host picks any track; everyone marks ready, then the host starts the race. Empty seats use AI. Each human has the same car performance. After the results, the host returns everyone to the same lobby for another race.
