...
export const TRACKS = [
  ...
  { id:'stunts', name:'DOS Descent', biome:'STUNT PARK', difficulty:4, rating:'EXPERT', width:8.5, aiSpeed:20, seed:1990,
    layout:'LOOP / PIPE / SKYWAY', revision:3, surface:'asphalt', stuntPark:true, accent:'#d8dce4', landmark:[-3,12], banner:[-20,36],
    ground:'#718c43', road:'#71777d', rut:'#696f75', edge:'#e6e8d5', foliage:'#315d35', rock:'#889393', sky:'#82b6da', sun:'#fff2d1',
    description:'A salute to Stunts / 4D Sports: Driving. Charge the loop, thread the pipe, ride the skyway and launch the jump. Follow the shifting yellow line through the loop and jump the raised drawbridges.',
    tip:'Steer through the offset loop, jump two lifting drawbridges, thread the pipe and climb the skyway — a salute to Stunts / 4D Sports: Driving.',
    points:[[-46,25],[-48,0],[-48,-28],[-22,-30],[8,-30],[40,-30],[48,-12],[48,20],[30,29],[14,23],[9,9],[20,-1],[14,-10],[-4,-10],[-16,-2],[-10,10],[-20,24],[-34,27]],
    // Arc-length boundaries of StuntCurve at offsetStart / offsetEnd;
    // endpoint tests guard these when the authored route changes.
    loop:{start:.21231503785244552,end:.2542556178553881,radius:10,shift:12,offsetStart:.22,offsetEnd:.24}, pipe:{start:.43,end:.50}, drawbridges:[{t:.10,length:9,phase:0},{t:.32,length:9,phase:15}], jumps:[.79], patches:[], obstacles:[] },
];
